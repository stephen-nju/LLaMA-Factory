...
export WANDB_PROJECT="Honor"
export WANDB_NAME="honor2_5b_lora_lr5e5_epoch2_bs8"
# 注意需要配置多节点训练的相关配置

export HOSTFILE=/home/jovyan/zhubin/LLaMA-Factory/config/hostfile
export MASTER_ADDR=10.71.130.130

deepspeed --hostfile=${HOSTFILE} --include="node13:4,5,6,7" --master_addr=${MASTER_ADDR} --master_port=${MASTER_PORT} src/train_bash.py \
	--deepspeed ${DS_CONFIG_STAGE_2} \
	--stage sft \
	--template qwen \
	--do_train \
	--model_name_or_path /home/jovyan/zhubin/DATA/models/Qwen2-1.5B/ \
	--resize_vocab true \
	...
	--cutoff 2048 \
	--output_dir  /home/jovyan/zhubin/saved_checkpoint/honor_2_5b_lora_lr5e5_epoch2 \
	--num_train_epochs 2 \
	--finetuning_type lora \
	--lora_target all \
	--warmup_ratio 0.1 \
